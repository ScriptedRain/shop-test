      ...
      <div className='grid grid-cols-12 gap-4 pt-4 row-span-2 grid-rows-1 pb-3 bg-gray-800'>
        ...
        <div className='col-start-10 col-span-2'>
          <button
            ...
            class='flex items-center justify-center w-full px-6 py-2.5 mx-2 text-sm font-medium text-white transition-colors duration-200 transform bg-indigo-500 rounded-md hover:bg-indigo-400 focus:bg-blue-400 focus:outline-none'
          >
