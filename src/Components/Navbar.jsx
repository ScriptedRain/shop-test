      ...
      <div className='grid grid-cols-12 gap-4 pt-4 row-span-2 grid-rows-1 pb-3 bg-gray-800'>
        ...
        <div className='col-start-10 col-span-1'>
          <button
            ...
            className='whitespace-nowrap ml-36 px-4 py-2 flex font-medium tracking-wide text-white transition-colors duration-200 bg-indigo-700 rounded-md hover:bg-indigo-500 hover:scale-105 hover: focus:ring-indigo-300 focus:ring-opacity-80'
          >
